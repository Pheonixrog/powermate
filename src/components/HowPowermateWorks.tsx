      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            ...
            >
              <Card className="py-8 flex items-center flex-col bg-gradient-to-b from-teal-950  to-gray-950 backdrop-blur-sm border-purple-500/20 hover:border-purple-400/40 transition-all duration-300 h-full w-full">
                <img
                  src={step.image}
                  alt={step.title}
