          ...
          <div className="w-full md:w-auto md:flex-1 text-left md:mt-10 mb-8 md:mb-0">
            ...
            >
              {/* <EnhancedTypography 
                ...
                gradient={true}
              /> */}
              <div className="my-0 md:my-20 relative flex items-start justify-start  md:items-center md:justify-center">
                <div className="absolute inset-0 bg-gradient-to-r " />
                <p className="relative  pl-2 md:pl-20 text-2xl sm:text-2xl md:text-6xl leading-relaxed mb-8 ">
